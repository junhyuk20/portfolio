		...
		<div class="row">
			<form action="/board/boardUpdate" method="post" onsubmit="return formCheck()">
				<table class="table table-striped" style="text-align: center; boder: 1px solid #dddddd ">
					...
					<tbody>
							<tr>
								<td><input type="text" class="form-control" id="board_title" name="board_title" maxlength="50" value="${list.BOARD_TITLE }"></td>
							</tr>
							<tr>
								<td><textarea class="form-control" id="board_context" name="board_context" maxlength="2000" style="height: 350px;">${list.BOARD_CONTEXT }</textarea></td>
							</tr>
					</tbody>
				</table>
